...
class Settings(BaseSettings):
    ...
    max_inflight_upload_parts_per_principal: int = Field(default=80, ge=1, le=256)
    max_inflight_upload_parts_per_session: int = Field(default=1, ge=1, le=1)
    max_inflight_upload_part_candidates: int = Field(default=128, ge=1, le=1024)
    max_active_upload_sessions_global: int = Field(default=128, ge=1, le=4096)
    max_active_upload_sessions_per_principal: int = Field(default=80, ge=1, le=256)
    max_reserved_upload_bytes_global: int = Field(default=1024 * 1024 * 1024 * 1024, ge=1)
    max_reserved_upload_bytes_per_principal: int = Field(default=1024 * 1024 * 1024 * 1024, ge=1)
